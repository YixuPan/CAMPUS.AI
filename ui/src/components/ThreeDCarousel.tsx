        ...
        {days.map((day, i) => {
          ...
          return (
            <motion.div
              ...
              onClick={() => !isDragging && onDaySelect(day)}
              whileHover={{ 
                scale: 1.05,
                zIndex: 100,
            ...
            >
              ...
              >
                ...
                {day.hasEvents && <div className="day-event-indicator"></div>}
              </motion.div>
            </motion.div>
          );
        })}
...
interface ThreeDCalendarCarouselProps {
  currentWeek: Date[];
  selectedDate: Date | null;
...
export function ThreeDCalendarCarousel({
  currentWeek,
  selectedDate,
  onSelectDate,
  eventsMap
}: ThreeDCalendarCarouselProps) {
  // Format days data
  ...
  return (
    <div className="days-carousel-container">
      <DaysCarousel
        days={days}
