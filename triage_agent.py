...
from agents.calendar.calendar_main import CalendarAgent
from agents.iot.iot_main import IoTAgent
from agents.speech.speech_main import SpeechAgent
from agents.attendance.attendance_main import AttendanceAgent
...
# --- Plugin for Controlling Sub-Agents ---
class SubAgentControlPlugin:
    def __init__(self, agent_classes: List[Type[BaseAgent]], show_thoughts: bool = True):
        """Initialize with a list of agent classes that inherit from BaseAgent."""
        self.show_thoughts = show_thoughts
        print("Initializing SubAgentControlPlugin...")
...
def create_triage_agent(show_thoughts: bool = True) -> ChatCompletionAgent:
    """Create and return a configured Triage Agent instance."""
    ...
    AVAILABLE_AGENTS = [CalendarAgent, IoTAgent, SpeechAgent, AttendanceAgent]  # List of available agent classes
    print("Initializing Triage Agent and its SubAgentControlPlugin...")
    sub_agent_plugin_instance = SubAgentControlPlugin(AVAILABLE_AGENTS, show_thoughts=show_thoughts)
    triage_kernel.add_plugin(plugin=sub_agent_plugin_instance, plugin_name="SubAgentControls")
    print("SubAgentControlPlugin added to Triage Kernel.")
    ...
    **Available Agents and Their Capabilities:**
    ...
    {sub_agent_plugin_instance.get_prompt_contributions()}
    ...
    **Your Process:**
    ...
    # Instantiate and return the Triage Agent
    ...
    print("Triage Agent instantiated.")
    return triage_agent 